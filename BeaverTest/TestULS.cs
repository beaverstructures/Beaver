...
namespace BeaverTest
{
    ...
    public class TestULS
    {
        ...
        public void TestULSDesign()
        {
            ...
            Material mat = new Material("C18", "Solid", 1.8, 1, 0.04, 1.8, 0.22, 0.34, 900, 600, 56, 30); // kN/cm^2, EN 338:2016
            crosec.Mat = mat;
            ...
            double Util0 = UtilsY[0][0];
            double Util1 = UtilsY[1][0];
            Console.WriteLine(Util0);
            Console.WriteLine(Util1);
