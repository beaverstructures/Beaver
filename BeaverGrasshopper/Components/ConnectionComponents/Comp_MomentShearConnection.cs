...
namespace BeaverGrasshopper.Components.ConnectionComponents
{
    public class Comp_MomentShearConnection : GH_Component
    {
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddParameter(new Param_ConnectionMoment(), "Connection", "Connection", "Beaver connection element with calculated results", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            for (int i = 0; i < connectionMoment.FastenerList.Count; i++)
            {
                ...
                out_utilizations.Add(connectionMoment.FastenerList[i].utilization[AnalysisType]);
