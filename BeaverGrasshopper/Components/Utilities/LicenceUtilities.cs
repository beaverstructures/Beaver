...
{
    class LicenceUtilities : PlugIn
    {
        /// <summary>
        /// Public constructor
        /// </summary>
        public LicenceUtilities()
        {
            Instance = this;
        }

        /// <summary>
        /// Gets the only instance of the LicenceUtilities plug-in.
        /// </summary>
        public static LicenceUtilities Instance
        {
            get; private set;
        }
        ...
        private static System.Drawing.Icon ProductIcon
        {
            get
            {
                return DrawingUtilities.LoadIconWithScaleDown("BeaverGrasshopper.Properties.Resources.BeaverIcon.png", 32);
            }
        }
    }
}
